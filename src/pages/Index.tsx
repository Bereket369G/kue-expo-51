  ...
  return <div className="min-h-screen bg-gradient-to-b from-[#F8F9FB] to-white">
      ...
      <div className="relative px-6 pt-12 pb-20 md:pt-20 md:pb-32 bg-blue-950">
        <div className="max-w-7xl mx-auto">
          ...
          duration: 0.6
        }} className="text-center mb-4 text-white text-3xl md:text-5xl font-light">
            Welcome To
          </motion.h2>
          ...
          duration: 0.6,
          delay: 0.3
        }} className="text-center mb-12 text-[#6DD5FA] font-bold text-4xl">February-27-2025</motion.p>
