      ...
      <div className="relative px-6 pt-12 pb-20 md:pt-20 md:pb-32">
        <div className="max-w-7xl mx-auto">
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-bold text-[#1A1F7C] text-center mb-6"
          >
            Ethiopian Athletics & Technology Summit
          </motion.h1>
          ...
          >
            Join us for a groundbreaking event that unites athletic excellence with technological innovation
          </motion.p>
          ...
          >
            <Button 
              ...
              className="bg-[#1A1F7C] hover:bg-[#2A307C] text-white px-8 py-6 rounded-full text-lg flex items-center gap-2"
            >
              Register Now
            ...
            <Button 
              ...
              variant="outline"
              className="px-8 py-6 rounded-full text-lg border-[#1A1F7C] text-[#1A1F7C] hover:bg-[#1A1F7C] hover:text-white"
            >
              View Schedule
            </Button>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">Connect with industry professionals and athletes</p>
            </motion.div>
          </div>
        </div>
      </div>
