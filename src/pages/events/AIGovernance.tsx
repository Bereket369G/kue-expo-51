  ...
  return (
    <div className="min-h-screen bg-[#1A1F7C] text-white">
      ...
      <div className="relative h-[240px] flex flex-col justify-end p-6 bg-gradient-to-b from-[#1A1F7C]/50 to-[#1A1F7C]">
        <h1 className="text-4xl font-bold mb-4">AI in Athletics</h1>
      ...
      <div className="bg-white text-black rounded-t-[32px] min-h-[500px] p-6">
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-sm text-center">02:00 PM</span>
          </div>
        ...
        <div className="space-y-4 text-gray-600">
          <p>
            Explore how artificial intelligence is revolutionizing athletic training and performance analysis. Learn about cutting-edge AI applications in sports science and athlete development.
          </p>
          <p>
            Features live demonstrations of AI-powered training analysis tools and interactive sessions with sports technology experts.
          </p>
        </div>
      </div>
    </div>
