  ...
  return (
    <div className="min-h-screen bg-[#1A1F7C] text-white">
      ...
      <div className="relative h-[240px] flex flex-col justify-end p-6 bg-gradient-to-b from-[#1A1F7C]/50 to-[#1A1F7C]">
        <h1 className="text-4xl font-bold mb-4">Innovation Summit</h1>
      ...
      <div className="bg-white text-black rounded-t-[32px] min-h-[500px] p-6">
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-sm text-center">09:30AM - 11:00AM</span>
          </div>
        ...
        <div className="space-y-4 text-gray-600">
          <p>
            Experience the cutting-edge of athletic innovation at our comprehensive summit. Join industry leaders, athletes, and innovators as we explore groundbreaking technologies and methodologies shaping the future of sports.
          </p>
          <p>
            Interactive demonstrations of emerging technologies and panel discussions with pioneering experts in sports science and athletic development.
          </p>
        </div>
      </div>
    </div>
