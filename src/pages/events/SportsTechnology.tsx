  ...
  return (
    <div className="min-h-screen bg-[#1A1F7C] text-white">
      ...
      <div className="relative h-[240px] flex flex-col justify-end p-6 bg-gradient-to-b from-[#1A1F7C]/50 to-[#1A1F7C]">
        <h1 className="text-4xl font-bold mb-4">Sports Technology Forum</h1>
      ...
      <div className="bg-white text-black rounded-t-[32px] min-h-[500px] p-6">
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-sm text-center">01:00 PM</span>
          </div>
        ...
        <div className="space-y-4 text-gray-600">
          <p>
            Discover the latest advancements in sports technology and their impact on athletic performance. From wearable tech to advanced training methodologies, explore how innovation is revolutionizing sports.
          </p>
          <p>
            Live demonstrations of cutting-edge sports technology and expert presentations on implementation strategies for athletic programs.
          </p>
        </div>
      </div>
    </div>
